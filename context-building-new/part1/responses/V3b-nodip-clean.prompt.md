# Trial V3b-nodip-clean — complete prompt as sent
...
fixture: `fixture_nodip_memory.json` · chars: 1485

```
Read this line chart: "Hourly Average Temperature Trend · Demo-Day (no threshold set, dip unremembered)".
...
Stats on plotted data: {"avg": 21.39, "last": 21.0, "max": 22.5, "maxAt": "11:00 label", "min": 18.1, "minAt": "02:00 label"}. Aggregation rule: Hourly points are raw hourly samples (no bucketing). Faults are per-hour sums.
...
Standing specifics: 
Quirk verdicts to obey: {"obey": [], "denied": []}
